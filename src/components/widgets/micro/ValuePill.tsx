...
export function ValuePill({ widget, state }: ValuePillProps) {
  ...
  return (
    <div
      className={`group min-h-[4.25rem] rounded-full border px-3.5 py-2.5 text-white backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] transition-all duration-200 ease-out hover:-translate-y-[1px] hover:shadow-[0_8px_24px_rgba(15,23,42,0.22)] ${
        active
